...
const Integration = () => {
    ...
    const [intergrationDetailsToken, setintergrationDetailsToken] = useState(
        '123456789'
    )
    const [intergrationDetailsApiKey, setintergrationDetailsApiKey] = useState(
        '123456789'
    )

    const dropdownHeadinfStyle = {
        fontFamily: "'YAFdJjTk5UU 0',_fb_,auto",
        fontSize: '18px',
        lineHeight: '33px',
        fontWeight: '700',
        color: '#000000',
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between w-[95%] mt-14">
                        <div className="ltr:ml-3 rtl:mr-3 w-[25%]">
                            <p style={dropdownHeadinfStyle}>
                                {intergrationDetails.name} API key
                            </p>
                        </div>
                        <div
                            className="ltr:ml-3 rtl:mr-3 w-[75%]"
                            style={{ overflowWrap: 'break-word' }}
                        >
                            <p className="w-[100%]">
                                {intergrationDetailsApiKey}
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center justify-between w-[95%]">
                        <div className="ltr:ml-3 rtl:mr-3 w-[25%]">
                            <p style={dropdownHeadinfStyle}>Token</p>
                        </div>
                        <div
                            className="ltr:ml-3 rtl:mr-3 w-[75%]"
                            style={{ overflowWrap: 'break-word' }}
                        >
                            <p className="w-[100%]">
                                {intergrationDetailsToken}
                            </p>
                        </div>
                    </div>
                </div>
                <div className="flex w-[50%] mx-auto justify-between mt-16">
                    <DialogButton
                        onClick={IntegrationConnect}
                    >
                        Connect
                    </DialogButton>
                    <DialogButton
